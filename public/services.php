                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            ${service.installation_id ? `
                                <a href="../api/generate_installation_pdf.php?id=${service.installation_id}" target="_blank" class="font-medium text-emerald-400 hover:underline flex items-center gap-1">
