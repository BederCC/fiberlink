    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-slate-900 border-r border-slate-800 sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-slate-900">
            <ul class="space-y-2 font-medium">
                ...
                $is_technician_dir = strpos($_SERVER['PHP_SELF'], '/technician/') !== false;
                $base_path = $is_technician_dir ? '../' : '';
                ...
                <li class="admin-only">
                    <a href="<?php echo $base_path; ?>clients.php" class="<?php echo getLinkClass('clients.php', $current_page); ?>">
                ...
                <li class="admin-only">
                    <a href="<?php echo $base_path; ?>plans.php" class="<?php echo getLinkClass('plans.php', $current_page); ?>">
                ...
                <li class="admin-only">
                    <a href="<?php echo $base_path; ?>products.php" class="<?php echo getLinkClass('products.php', $current_page); ?>">
                ...
                <li class="admin-only">
                    <a href="<?php echo $base_path; ?>technical.php" class="<?php echo getLinkClass('technical.php', $current_page); ?>">
                ...
                <li class="admin-only">
                    <a href="<?php echo $base_path; ?>reports.php" class="<?php echo getLinkClass('reports.php', $current_page); ?>">
